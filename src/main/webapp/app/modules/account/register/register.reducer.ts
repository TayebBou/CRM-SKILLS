...
// Actions
export const handleRegister = (firstName, lastName, login, email, password, langKey = 'fr') => ({
  type: ACTION_TYPES.CREATE_ACCOUNT,
  payload: axios.post('api/register', { firstName, lastName, login, email, password, langKey }),
  meta: {
